    ...
    return SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          Restaurant(
            ...
            price: "₽₽₽",
            description:
                "Семейный ресторан «Гуси-лебеди» смело можно назвать уникальным. И дело не только в огромных масштабах, невероятном интерьере и гигантском меню, хотя и это, конечно, впечатляет.",
          ),
          Restaurant(
            title: "Medici",
            ...
            price: "₽₽₽",
            description:
                "Какие гастрономические образы возникают в воображении, когда вы думаете об Италии? Свежеиспеченная чиабатта, спелый виноград, нежнейшая расплавленная моцарелла и ароматный кофе. ",
          ),
        ]));
  }
}
